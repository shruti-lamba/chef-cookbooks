...
if node['platform'] == 'centos'
  default['php']['packages'] = %w(php-devel php-fpm php-bcmath php-dba php-enchant php-gd php-imap php-intl php-ldap php-mbstring php-mcrypt php-mysql php-odbc php-pgsql php-snmp php-soap php-tidy php-xml)
