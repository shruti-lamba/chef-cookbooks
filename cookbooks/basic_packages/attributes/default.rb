...
if node['platform'] == 'centos'
  default['common']['packages'] = %w(bash-completion bash-completion-extras gcc-c++ pcre-devel tcl zlib-devel make wget openssl-devel libxml2-devel libxslt-devel gd-devel perl-ExtUtils-Embed GeoIP-devel gperftools-devel vim mlocate sysstat git)
